...
<p><a href="videos.php">Manage Videos</a> · <a href="analytics.php">Analytics</a> · <a href="promotions.php">Promotions</a> · <a href="settings.php">Channel Settings</a> · <a href="../index.php">Back to Site</a></p></div>
<div class="grid">
...
<div class="panel"><h3>Top Videos This Week</h3><?php if(!$myTop): ?><p class="muted">No view data yet.</p><?php else: ?><div class="grid"><?php foreach($myTop as $v){ renderVideoCard($v);} ?></div><?php endif; ?></div>
</main></div></body></html>
